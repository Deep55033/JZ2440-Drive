...
#define     __REG_CHAR(x)					(*(volatile unsigned char *)(x))
...
#define     NFCCMD                   __REG_CHAR(0x4E000008)  //NAND flash command
#define     NFADDR                   __REG_CHAR(0x4E00000C)  //NAND flash address
#define     NFDATA                   __REG_CHAR(0x4E000010)  //NAND flash data
...
#define     UTXH0                    __REG_CHAR(0x50000020)  //UART 0 transmission hold
#define     URXH0                    __REG_CHAR(0x50000024)  //UART 0 receive buffer
